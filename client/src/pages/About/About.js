            ...
            <Row className='aboutRow'>
                <Col md={{ span: 6, offset: 3 }}>
                    ...
                    <p>
                        ...
                        <br />
                        <br />
                           Pure fruit started in late 1990s with logistic service only.
                            In 2018, we decided to transit into direct fruit sales business
                             that allows our customers to pre-order imported fruits.
                        <br />
                        <br />
