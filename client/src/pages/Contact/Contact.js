        ...
        <Container className='contactContainer'>
            <Row className='contactRow'>
                ...
                <Col sm={4}>
                    ...
                    <p>A: You can pay on the day of collection.
                         We accept cash and credit card payments.</p>
                    <br />
                    <p><strong>Q: How will I get a notification?</strong></p>
                    <p>A: Notifications are sent via
                         Email usually one week before the product arrives.</p>
                </Col>
            </Row>
        </Container>
        <Footer />
